const buildExcursionCards = (excursionCardInfo) => {
  ...
  domString += '<button type="button" class="editExcursion col-5 btn-default btn-lg excursionCrudButtonColor glowing"><i class="fas fa-feather-alt"></i> Edit Excursion</button>';
