const buildExcursionCards = (excursionCardInfo) => {
  ...
  domString += '<button type="button" id="add-species-modal" class="col-5 btn-default btn-lg excursionCrudButtonColor glowing"><i class="fas fa-fish"></i> Species Seen </button>';
