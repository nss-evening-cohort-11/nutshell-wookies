const buildExcursionCards = (excursionCardInfo) => {
  ...
  domString += '<button type="button" class="col-11 btn-default btn-lg excursionRowCrudButtonColor glowing"><i class="fas fa-skull-crossbones"></i> Delete Excursion</button>';
  domString += '</div>';
  domString += '</div>';
