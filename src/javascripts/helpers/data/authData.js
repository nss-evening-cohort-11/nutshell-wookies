...
import singleViewExcursionSpecies from '../../components/singleViewExcursionSpecies/singleViewExcursionSpecies';
...
const checkLoginStatus = () => {
  firebase.auth().onAuthStateChanged((user) => {
    ...
    singleViewExcursionSpecies.speciesExcursionEvents();
  });
};
